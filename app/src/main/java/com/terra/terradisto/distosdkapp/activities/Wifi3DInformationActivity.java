...
public class Wifi3DInformationActivity extends WifiInformationActivity{
    ...
    public void setContentView() {
        setContentView(R.layout.activity_wifi_3d_information);
    }
    ...
    void initMembers() {
        ...
        View.OnClickListener buttonListener = new Wifi3DInformationActivity.ButtonListener();
